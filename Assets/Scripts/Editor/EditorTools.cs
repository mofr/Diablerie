...
public class EditorTools
{
    ...
    static public void GenerateDatasheetLoaders()
    {
        ...
        var recordTypes = new System.Type[] { typeof(BodyLoc), typeof(SoundInfo), typeof(OverlayInfo), typeof(MonSound), typeof(LevelType), typeof(SkillInfo), typeof(MissileInfo)};
