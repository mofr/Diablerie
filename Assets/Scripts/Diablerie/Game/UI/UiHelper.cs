...
namespace Diablerie.Game.UI
{
    ...
    {
        public static GameObject CreateAnimatedObject(string name, string spritePath = "", PaletteType paletteType = PaletteType.Act1, Material material = null, bool loop = true, bool hideOnFinish = false, int sortingOrder = 0)
        {
            ...
            if (material != null)
            {
                animator.Renderer.material = material;
            }
